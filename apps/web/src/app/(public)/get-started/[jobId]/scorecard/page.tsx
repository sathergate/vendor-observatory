...
export default async function ScorecardPage({
  ...
  if (status.stages.balanced.status !== "complete") {
    redirect(`/get-started/${jobId}`);
  }
    ...
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center gap-3 mt-2">
          ...
          <span className="text-sm text-gray-500">
            {balancedData.sessions_analyzed} sessions analyzed
          </span>
        </div>
      </div>
      ...
      <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 mb-6">
        ...
        <p className="text-sm text-gray-500 mt-2">
          Based on mention rate ({balancedData.mention_rate}%), platform coverage,
          and recommendation context across {balancedData.platforms.join(", ")}.
        </p>
      </div>
