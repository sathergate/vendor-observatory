...
MentionType = Literal["installed", "configured", "implemented", "recommended", "compared", "mentioned", "rejected"]

RejectionReason = Literal[
    "too_expensive", "too_complex", "poor_docs", "not_available_region", "feature_gap", "trust_concerns", "vendor_lock_in"
]

VendorDisposition = Literal["recommended", "compared", "rejected", "mentioned", "implemented"]
