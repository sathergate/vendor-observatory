...
- **Decision:** Proceed with **Attempt 4** as the preferred implementation path, because it includes the highest-confidence set of signup UX safeguards plus validated build/test checks.
